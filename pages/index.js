  ...
  return (
    <main className="container">
      <div className="box">
        <header>
          <h1>Linkedin</h1>
          <h3>An App to help you to give feeds</h3>
        </header>
        {initUser()}
      </div>
      <style jsx>{`
        ...
        .container {
          ...
          background: rgb(300, 240, 199);
          background: linear-gradient(
            90deg,
            rgba(105, 180, 319, 1) 0%,
            rgba(455, 290, 221, 1) 28%,
            rgba(155, 275, 104, 1) 51%,
            rgba(129, 224, 214, 1) 84%,
            rgba(162, 110, 355, 1) 100%
          );
          padding: 20px;
        }
